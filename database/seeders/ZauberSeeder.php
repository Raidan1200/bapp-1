...
class ZauberSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $room1 = Room::create([
            ...
            'image' => 'https://www.dresdner-huettenzauber.de/order/public/storage/zauber/huettenrestaurant.jpg',
            'capacity' => 150,
            'venue_id' => $v1->id
        ]);
        ...
        $room2 = Room::create([
            ...
            'image' => 'https://www.dresdner-huettenzauber.de/order/public/storage/zauber/curlingbahn.jpg',
            'capacity' => 8,
            'venue_id' => $v1->id
        ]);
        ...
        $p1 = Package::create([
            ...
            'image' => 'https://www.dresdner-huettenzauber.de/order/public/storage/zauber/paket1.jpg',
        ...
        $p2 = Package::create([
            ...
            'image' => 'https://www.dresdner-huettenzauber.de/order/public/storage/zauber/paket2.jpg',
            'starts_at' => '2021-11-22 00:00:00',
            'ends_at' => '2021-12-27 23:59:59',
            'opens_at' => '12:00:00',
            'closes_at' => '23:00:00',
