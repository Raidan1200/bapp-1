...
class VenueSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $v2room1 = Room::factory()->create(['name' => 'Schloss', 'venue_id' => $v2->id]);
        $v2room2 = Room::factory()->create(['name' => 'Tretboot', 'venue_id' => $v2->id]);
        Product::factory()->create(['room_id' => $v2room1->id]);
        Product::factory()->create(['room_id' => $v2room1->id]);
        Product::factory()->create(['room_id' => $v2room1->id]);
        Product::factory()->create(['room_id' => $v2room2->id]);
    }
}
