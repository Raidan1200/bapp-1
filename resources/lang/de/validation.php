...
return [
    ...
    'attributes' => [
        ...
        'city'                  => 'Stadt',
        'capacity'              => 'Kapazität',
        'check_delay'           => 'Mitarbeiternotitz nach',
        'closes_at'             => 'Öffnungszeit bis',
        'content'               => 'Inhalt',
        'country'               => 'Land',
        ...
        'deposit'               => 'Anzahlung',
        'ends_at'               => 'Angeboten bis',
        'email'                 => 'E-Mail Adresse',
        'excerpt'               => 'Auszug',
        'first_name'            => 'Vorname',
        'gender'                => 'Geschlecht',
        'hour'                  => 'Stunde',
        'invoice_id_format'     => 'Rechnungsnummernformat',
        'last_name'             => 'Nachname',
        'minute'                => 'Minute',
        ...
        'month'                 => 'Monat',
        'name'                  => 'Name',
        'not_paid_delay'        => 'Unbezahlt nach',
        'opens_at'              => 'Öffnungszeit von',
        'password'              => 'Passwort',
        'password_confirmation' => 'Passwort Bestätigung',
        'phone'                 => 'Telefonnummer',
        'role'                  => 'Rolle',
        'reminder_delay'        => 'Erinnerungsmail nach',
